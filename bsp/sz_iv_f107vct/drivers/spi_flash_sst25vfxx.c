...
#define MT_ID                       (0x30)
/* JEDEC Device ID: Memory Capacity */
#define MC_ID_W25X16            	(0x15) /* 16Mbit */
#define MC_ID_W25X32            	(0x16) /* 32Mbit */
#define MC_ID_W25X64            	(0x17) /* 64Mbit */
